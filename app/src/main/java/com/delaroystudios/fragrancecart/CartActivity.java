...
public class CartActivity extends AppCompatActivity implements LoaderManager.LoaderCallbacks<Cursor> {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Toast.makeText(CartActivity.this,"Swipe to delete the item",Toast.LENGTH_LONG).show();
    ...
    protected void onActivityResult (int requestCode, int resultCode, Intent data) {
        if (resultCode == Activity.RESULT_OK) {
            ...
            Toast.makeText(CartActivity.this,"The Payment was canceled!",Toast.LENGTH_LONG).show();
        }
        else if (resultCode == PaymentActivity.RESULT_EXTRAS_INVALID) {
            Log.i("paymentExample", "An invalid Payment or PayPalConfiguration was submitted. Please see the docs.");
            Toast.makeText(CartActivity.this,"Select an item to buy!",Toast.LENGTH_LONG).show();
        }
